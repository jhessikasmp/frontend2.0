			...
			<div className="bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-6 mb-6">
				<ResponsiveContainer width="100%" height={300}>
					<BarChart data={monthlyExpenses} margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
						...
						<XAxis dataKey="_id.month" tickFormatter={month => `${month.toString().padStart(2, '0')}/${year}`} />
						<YAxis />
						<Tooltip formatter={(value: number) => `€ ${value.toLocaleString('de-DE', { minimumFractionDigits: 2 })}`} labelFormatter={label => `Mês: ${label}`} />
